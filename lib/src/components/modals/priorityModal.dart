...
class PriorityModal extends StatelessWidget {
  final DetailsModalController controller = Get.find<DetailsModalController>();
  final RxInt _tempSelectedPriority = RxInt(0);

  PriorityModal({Key? key}) : super(key: key);
...
void showPriorityModal(BuildContext context) {
  showModalBottomSheet(
    ...
    builder: (BuildContext context) => PriorityModal(),
  );
}
